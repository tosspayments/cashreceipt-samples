...
<%
  ...
  String receiptKey = "J4qjZblEopLBa5PzR0ArnwqJ2dqoo8vmYnNeDMyW2G1OgwK7";
  ...
  URL url = new URL("https://api.tosspayments.com/v1/cash-receipts/" + receiptKey + "/cancel");
...
<section>
    ...
    if (isSuccess) { %>
        ...
        <p>canceledAt : <%= jsonObject.get("canceledAt") %></p>
